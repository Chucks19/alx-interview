...
Each integer represents 1 bite data.
"""
...
def validUTF8(data):
    ...
    for by in data:
        ...
        if expect_continua_bytes == 0:
            ...
            if expect_continua_bytes == 1 or\
                    expect_continua_bytes > 4:
                return False
        ...
        # If we are expecting continuation bytes
            ...
            if not (by & UT_1 and not (by & UT_2)):
                return False
